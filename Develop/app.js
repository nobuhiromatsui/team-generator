...
function createTeam() {
    inquirer.prompt({
        ...
        if (employeeType === "engineer"){
            ...
            const writeTeam = render(employees);
            // console.log(render(employees));
            asyncWriteFile(outputPath, writeTeam).then(() => console.log("success"))
        }
    })
}
...
function createIntern() {
    inquirer.prompt([...generalQuestion, internQuestion])
